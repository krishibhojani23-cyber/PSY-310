...
expName = 'adaptive staircase'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\stroop\\adaptive staircase_lastrun.py',
