...
expName = 'Orientation Discrimination Task'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\stroop\\Orientation Discrimination Task_lastrun.py',
